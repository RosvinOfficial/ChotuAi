...
async def imagine(interaction: discord.Interaction, prompt: str):
    # Defer because fetching the image takes a couple of seconds
    await interaction.response.defer()
    ...
    try:
        ...
        # Add a random seed so if someone types the exact same prompt twice, 
        # they get a different image each time
        seed = random.randint(1, 100000)
        
        # Pollinations.ai generates the image instantly based on this URL
